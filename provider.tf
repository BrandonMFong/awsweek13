...
resource "aws_route_table_association" "week13-sub-a-assoc" {
  subnet_id      = aws_subnet.week13-sub-a.id
  route_table_id = aws_route_table.week13-pub-rt.id
}
...
resource "aws_route_table_association" "week13-sub-b-assoc" {
...
resource "aws_route_table_association" "week13-pri-a-assoc" {
...
resource "aws_route_table_association" "week13-pri-b-assoc" {
  subnet_id      = aws_subnet.week13-pri-b.id
  route_table_id = aws_route_table.week13-pri-rt.id
}

# Internet Gate Way 
resource "aws_internet_gateway" "week13-igw-v2" {
  vpc_id = aws_vpc.week13-vpc.id
...
resource "aws_route_table" "week13-pub-rt" {
  vpc_id = aws_vpc.week13-vpc.id

  route = [{
    cidr_block = "0.0.0.0/0"
    gateway_id = aws_internet_gateway.week13-igw-v2.id
...
# Security Group
resource "aws_security_group" "week13-ssh-sg-v2" {
  name        = "week13_ssh_sg"
